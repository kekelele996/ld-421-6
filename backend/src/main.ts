...
import { ApiError, ok, created } from "./utils/response.ts";
...
server.listen(port, host, () => {
  console.log(`lab-equipment backend listening on ${host}:${port}`);
});
